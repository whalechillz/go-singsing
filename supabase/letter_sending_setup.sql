...
-- 인덱스 생성
CREATE INDEX IF NOT EXISTS idx_letter_sending_golf_course ON letter_sending_history(golf_course_contact_id);
CREATE INDEX IF NOT EXISTS idx_letter_sending_date ON letter_sending_history(sent_date);
CREATE INDEX IF NOT EXISTS idx_letter_sending_occasion ON letter_sending_history(occasion);
CREATE INDEX IF NOT EXISTS idx_letter_sending_status ON letter_sending_history(status);
...
-- 트리거 생성
DROP TRIGGER IF EXISTS trigger_update_letter_sending_history_updated_at ON letter_sending_history;
