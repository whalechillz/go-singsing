...
import { Plus, Edit2, Trash2, Search, Phone, User, UserCheck, Bus, MapPin, Users } from "lucide-react";
...
export default function TourStaffManagementPage() {
  ...
  // 역할별 통계
  const roleStats = Object.entries(staffByRole).map(([role, staffs]) => ({
    role,
    count: staffs.length
  }));
  ...
  return (
    <div className="p-6">
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-gray-900">투어 운영진 관리</h1>
        <p className="text-gray-600 mt-1">투어별 운영진(기사, 가이드, 인솔자)을 관리합니다.</p>
      </div>
            ...
            return (
              <div key={role} className="bg-white rounded-lg shadow">
                <div className="p-4 bg-gray-50 border-b flex items-center gap-2">
                  ...
                  <span className="text-sm text-gray-500">({staffs.length}명)</span>
                </div>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  min="1"
                />
                <p className="text-xs text-gray-500 mt-1">출력 시 표시 순서</p>
              </div>
            </div>
