              ...
              {menu && (
                <div className="mt-2 bg-gray-50 rounded p-3 text-xs">
                  ...
                  <div className="flex flex-col gap-1">
                    <div><span className="font-semibold">조식:</span> {menu.breakfast}</div>
                    <div><span className="font-semibold">중식:</span> {menu.lunch}</div>
                    <div><span className="font-semibold">석식:</span> {menu.dinner}</div>
                  </div>
                </div>
              )}
            </div>
