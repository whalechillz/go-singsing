...
export default function ModernAdminSidebar({ isCollapsed, onCollapse }: ModernAdminSidebarProps) {
  ...
  const getActiveNav = () => {
    ...
    if (pathname.startsWith('/admin/marketing-content')) return 'marketing-content';
  ...
  const navItems: NavItem[] = [
    ...
    { 
      ...
      subMenu: [
        ...
        { id: 'badge-design', label: '뱃지 디자인', href: '/admin/design-system/badges' },
        { id: 'favicon-showcase', label: '파비콘 디자인', href: '/admin/design-system/favicon' },
      ]
    },
    { 
