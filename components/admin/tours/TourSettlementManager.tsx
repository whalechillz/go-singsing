          ...
          {activeTab === "expenses" && expenses && (
            <div className="space-y-6">
              ...
              <div className="bg-gray-50 rounded-lg p-6">
                <h4 className="text-lg font-semibold text-gray-900 mb-4">골프장 정산</h4>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="text-sm text-gray-500 flex items-end">
                    <span>골프장 정산 상세는 JSONB로 관리됩니다.</span>
                  </div>
                </div>
              </div>
              ...
              {/* 경비 지출 */}
              <div className="bg-gray-50 rounded-lg p-6">
                <h4 className="text-lg font-semibold text-gray-900 mb-4">경비 지출</h4>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1">
                      경비 지출 총합
                    ...
                    <input
                      ...
                      onChange={(e) => setExpenses({
                        ...expenses,
                        meal_expenses_total: parseInt(e.target.value) || 0
                      })}
                      className="w-full border rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-600"
                      placeholder="0"
                    />
                  ...
                  <div className="text-sm text-gray-500 flex items-end">
                    <span>경비 지출 상세는 JSONB로 관리됩니다. (김밥, 생수, 간식 등)</span>
                  </div>
                </div>
              </div>
